...
class ScpToLocalFileTest extends SshCase
{
    ...
    public function test_scp_recv_file_to_file()
    {
        ...
        $copied = self::$sshClient->scpRemote('/tmp/file.txt')->to($localFileName);
    ...
    public function test_scp_send_recv_to_directory()
    {
        ...
        $copied = self::$sshClient->scpRemote('/tmp/file.txt')->to($localDir);
